...
int main(int, char**) {
    ...
    // wrap mongocxx::collection in a collection_wrapper
    mangrove::collection_wrapper<Restaurant> restaurants(restaurants_col);
    ...
    // get all restaurants in collection
    {
        ...
        mangrove::deserializing_cursor<Restaurant> cur = restaurants.find({});
